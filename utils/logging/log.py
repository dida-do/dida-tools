...
class Log():
    ...
    level        -- Level that indicates the priority of the message (Debug 10, Info 20, Warning 30, Error 40, Critical 50)
    ...
    def set_level(self, level : int):
        '''Sets the level of information that shall be recorded. If a message has a lower level it will be ignored.
...
def log(some_function_or_data, logger : Log = None, verbose : bool = False) -> None:
    ...
    logger (optional)     -- a Log() element. If not given it will search in scope for one or create a new one
    '''
